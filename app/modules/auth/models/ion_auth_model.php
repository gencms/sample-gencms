...
class Ion_auth_model extends CMS_Model
{
	/**
	...
	public function __construct()
	{
		...
		//initialize data
		$this->userid_column = $this->config->item('id_user', 'ion_auth');
	...
	public function activate($id, $code = false)
	{
		...
		if ($code !== FALSE)
		{
            ...
            $query_user_id = $this->db->select($this->userid_column)
                                  ->where('activation_code', $code)
                                  ->limit(1)
                                  ->get($this->tables['users']);

            $result_user_id = $query_user_id->row();
			...
			$iduser = $result_user_id->{$this->userid_column};
     ...
     * @author Mathew
     **/
    public function registration($username, $password, $email, $additional_data = array(), $groups)
    {
        $this->trigger_events('pre_registration');
        ...
        $this->trigger_events('post_registration');
...
//		$query = $this->db->select($this->identity_column . ', username, email, id, password, active, last_login')
	...
	**/
	...
	/*
     * This function returns an empty employer object.
     *
     */
     public function get_new_employer()
     {
